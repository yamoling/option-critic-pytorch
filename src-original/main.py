...
parser.add_argument("--epsilon-decay", type=float, default=10000, help=("Number of steps to minimum epsilon."))
...
parser.add_argument("--torch-deterministic", type=bool, default=True, help="Force deterministic torch behavior")
...
def run(args):
    ...
    logger = Logger(logdir=args.logdir, run_name=f"{datetime.now().isoformat()}")
